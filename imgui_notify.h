...
#pragma once
#include "includes.h"
#include "font_awewsome_5.h"
#include "fa_solid_900.h"

#define NOTIFY_MAX_MSG_LENGTH			100		// Max message content length
#define NOTIFY_PADDING_X				16.f		// Bottom-left X padding
#define NOTIFY_PADDING_Y				16.f		// Bottom-left Y padding
#define NOTIFY_PADDING_MESSAGE_Y		10.f		// Padding Y between each message
#define NOTIFY_FADE_IN_OUT_TIME			250			// Fade in and out duration
	...
	NOTIFY_INLINE auto get_default_title() -> const char*
	{
		if (!strlen(this->title))
		{
			...
			case ImGuiToastType_Info:
				return "Info";
			case ImGuiToastType_LM:
				return "LobbyMessage";
			case ImGuiToastType_PE:
				return "PackageElement";
			case ImGuiToastType_MT:
				return "Loadside";
			case ImGuiToastType_IM:
				return "dwInstantMessage";
